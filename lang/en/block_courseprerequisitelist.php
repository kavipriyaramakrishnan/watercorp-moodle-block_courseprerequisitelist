...
/**
 * Strings for component 'block_courseprerequisitelist', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['courseprerequisitelist:addinstance'] = 'Add a new courses block';
$string['courseprerequisitelist:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['courses'] = 'Courses';
$string['display'] = 'Display';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = 'Course Prerequisite List';
